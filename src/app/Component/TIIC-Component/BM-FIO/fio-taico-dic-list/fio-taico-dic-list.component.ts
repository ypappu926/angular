...
@Component({
  selector: 'app-fio-taico-dic-list',
  templateUrl: './fio-taico-dic-list.component.html',
  styleUrls: ['./fio-taico-dic-list.component.scss']
})
export class FIOTaicoDICListComponent implements OnInit {
