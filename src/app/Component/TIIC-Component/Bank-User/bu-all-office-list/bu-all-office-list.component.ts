...
@Component({
  selector: 'app-bu-all-office-list',
  templateUrl: './bu-all-office-list.component.html',
  styleUrls: ['./bu-all-office-list.component.scss']
})
export class BUAllOfficeListComponent implements OnInit {
