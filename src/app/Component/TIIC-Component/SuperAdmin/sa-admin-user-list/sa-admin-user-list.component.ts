...
declare var $: any;
@Component({
  selector: 'app-sa-admin-user-list',
  templateUrl: './sa-admin-user-list.component.html',
  styleUrls: ['./sa-admin-user-list.component.scss']
})
export class SAAdminUserListComponent implements OnInit {
