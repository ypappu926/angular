...
declare var $: any;
@Component({
  selector: 'app-sa-field-inspection-officer',
  templateUrl: './sa-field-inspection-officer.component.html',
  styleUrls: ['./sa-field-inspection-officer.component.scss']
})
export class SAFieldInspectionOfficerComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.BankUserData = this.BankUserData;
