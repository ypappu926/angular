...
@Component({
  selector: 'app-sa-general-managers-list',
  templateUrl: './sa-general-managers-list.component.html',
  styleUrls: ['./sa-general-managers-list.component.scss']
})
export class SAGeneralManagersListComponent implements OnInit {
