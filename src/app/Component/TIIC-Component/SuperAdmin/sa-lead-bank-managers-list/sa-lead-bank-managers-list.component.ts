...
@Component({
  selector: 'app-sa-lead-bank-managers-list',
  templateUrl: './sa-lead-bank-managers-list.component.html',
  styleUrls: ['./sa-lead-bank-managers-list.component.scss']
})
export class SALeadBankManagersListComponent implements OnInit {
