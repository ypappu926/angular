...
export class TnService {
  ...
  getProductListByUserId(): Observable<any> {
    return this.http.get(RestUrl.GET_PRODUCT_LIST_BY_USER_ID, false);
  }

  getCommonList(listKey, whereClause): Observable<any> {
    return this.http.post(RestUrl.GET_COMMON_LIST, { listKey, whereClause });
  }
